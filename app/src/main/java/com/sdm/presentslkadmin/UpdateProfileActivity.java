...
public class UpdateProfileActivity extends AppCompatActivity {
    ...
    String textFullName, textDoB, textMobile, textAddress;
    ...
    private void bottomNavigation(int itemId) {
        if (itemId == R.id.home) {
            ...
            startActivity(new Intent(UpdateProfileActivity.this, ProductActivity.class));
            overridePendingTransition(0, 0);
        } else if (itemId == R.id.users) {
            startActivity(new Intent(UpdateProfileActivity.this, UsersActivity.class));
            overridePendingTransition(0, 0);
        } else if (itemId == R.id.orders) {
            startActivity(new Intent(UpdateProfileActivity.this, OrdersActivity.class));
            overridePendingTransition(0, 0);
