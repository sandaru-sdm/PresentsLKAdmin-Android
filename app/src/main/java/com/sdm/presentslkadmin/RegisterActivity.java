...
public class RegisterActivity extends AppCompatActivity {
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(textFullName)){
                    ...
                    String textUserType = "admin";

                    registerAdmin(textFullName, textEmail, textDob, textMobile, textAddress, textPwd, textUserType);
                }
    ...
    private void registerAdmin(String textFullName, String textEmail, String textDob, String textMobile, String textAddress, String textPwd, String textUserType) {
