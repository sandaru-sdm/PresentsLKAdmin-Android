...
public class LoginActivity extends AppCompatActivity {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    if (firebaseUser.isEmailVerified()) {
                        ...
                        String userId = firebaseUser.getUid();
                        checkAdminAndSendVerificationEmail(userId);
                    }
    ...
    private void checkAdminAndSendVerificationEmail(String userId) {
        DatabaseReference userRef = FirebaseDatabase.getInstance().getReference("Registered Admins").child(userId);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if ("admin".equals(userType)) {
                        ...
                        editTextLoginEmail.setError("Users cannot log in from this app");
                        editTextLoginEmail.requestFocus();
                        editTextLoginEmail.setText("");
                        editTextLoginPassword.setText("");
                    }
                } else {
                    Toast.makeText(LoginActivity.this, "Admin data not found", Toast.LENGTH_LONG).show();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if ("user".equals(userType)) {
                        ...
                        editTextLoginEmail.setText("");
                        editTextLoginPassword.setText("");
                        Toast.makeText(LoginActivity.this, "Users cannot log in from this app", Toast.LENGTH_LONG).show();
                        firebaseAuth.signOut(); // Sign out the user
                    } else {
